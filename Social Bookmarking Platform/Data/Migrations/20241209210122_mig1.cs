    ...
    public partial class mig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookmarkBoards", x => new { x.BookmarkId, x.BoardId });
                    table.ForeignKey(
                        name: "FK_BookmarkBoards_Boards_BoardId",
                        column: x => x.BoardId,
                        principalTable: "Boards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookmarkBoards_Bookmarks_BookmarkId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookmarkBoards_BoardId",
